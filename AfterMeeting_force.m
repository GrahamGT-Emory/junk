...
[Y1, T1, X1] = compile_jango_neuraldata_force(whichtargets,numSamp,numDelay,filename);
X1 = X1(:,1:2);
filename = 'binnedData_0807.mat';
[Y2, T2, X2] = compile_jango_neuraldata_force(whichtargets,numSamp,numDelay,filename);
X2 = X2(:,1:2);
Filename = 'binnedData_0819.mat';
[Y3, T3, X3] = compile_jango_neuraldata_force(whichtargets,numSamp,numDelay,filename);
X3 = X3(:,1:2);
filename = 'binnedData_0901.mat';
[Y4, T4, X4] = compile_jango_neuraldata_force(whichtargets,numSamp,numDelay,filename);
X4 = X4(:,1:2);
